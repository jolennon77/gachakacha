...
.sidebar .nav-item .collapse {
    ...
    animation-timing-function: transform cubic-bezier(.18, 1.25, .4, 1),
        opacity cubic-bezier(0, 1, .4, 1)
}
...
.bg-gradient-primary {
    background-color: #756455;
    background-image: linear-gradient(180deg, #756455 10%, #6b5b4e 100%);

				...
				<div class="container-fluid">
							...
							<table class="main_productTable" border="1">
								...
								<tbody>
									...
									<tr>
										<th>제품명</th>
										<!-- 대표 제품명 입력 필드 -->
										<td data-td="product_td"><input type="text" name="p_Name"
											id="p_Name" placeholder="예) 치이카와 천사 악마 쿠지!"
						...
						<div class="product_insert_submit">
							...
							<div>
								<input class="btn" type="submit" value="수정"> <span
									class="del_Button"><a
									href="deleteProduct.admin?pId=${product.getProduct_Id()}">삭제</a></span>
							</div>
						</div>
					</form>
					<br> <br> <br>
					...
					<div class="option_table">
						...
						<table class="option_table" border="1">
							...
							<thead>
								<tr>
									<th class="headth">옵션<br>ID
									</th>
									<th class="headth">옵션<br>이미지
									</th>
								...
								<c:forEach items="${optionList}" var="option">
									<form
										...
										<tr>
											...
											<td>
												<!-- 수정 버튼 --> <input type="hidden" name="option_ID"
												value="${option.getOption_ID()}"> <input
												id="update_iButton" type="submit" value="수정"> <span
												class="del_AButton"> <a
													href="deleteOption.admin?oId=${option.getOption_ID()}&pId=${option.getProduct_ID()}">삭제</a>
											</span>

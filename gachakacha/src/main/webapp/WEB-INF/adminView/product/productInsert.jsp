								...
								<div class="table-responsive">
									...
									<form id="productForm" action="insert.product" method="post">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<div class="select__block">
																<select class="select__block" name="p_Cat" id="p_Cat"
																	required>
													...
													<tr>
														...
														<td colspan="4"><input class="text__block"
															type="text" name="p_Price" id="p_Price"
															placeholder="예) 15000" required></td>
													</tr>
													<tr>
														<th>제품 이미지 URL</th>
														<td colspan="4"><input class="text__block"
															type="text" name="p_Img" id="p_Img"
															placeholder="예) www.img.jpg"></td>
													</tr>
													<tr>
														<th>제품 설명</th>
														<td colspan="4"><input class="text__block"
															type="text" name="p_Con" id="p_Con" placeholder="제품설명">
														</td>
													</tr>
												</tbody>
											</table>
										...
										<div class="basic_submit_zone">
											<input class="btn submitbtn insertbtn"
										...
										<div class="option input__block">
											...
											<table class="table optionTable" id="dataTable" width="100%"
												...
												<tbody>
														...
														<td colspan="5" id="optionAddBtn">
															...
															<div>
																<a href="javascript:;" onclick="copyOptionTable();"
																	class="btn btn-xs type-copy copy-button"> <i
																	class="fa-solid fa-square-plus"></i>

																</a> <a href="javascript:;" style="display: none;"
																	class="btn btn-xs type-delete delete-button"> <i
													...
													<tr>
														<td><input class="text__block" type="text"
															name="o_Name[]" id="o_Name[]" placeholder="예) 치이카와 피규어"
															required></td>
														<td><input class="text__block" type="text"
															name="o_ID[]" id="o_ID[]" placeholder="자동생성"
															readonly="readonly"></td>
														<td>
															<div class="select__block">
																<select class="option-select" name="o_Grade[]"
																	id="o_Grade[]" style="width: 100%" required>
														...
														<td><input class="text__block" type="text"
															name="o_Img[]" id="o_Img[]" placeholder="예) www.img.jpg">
														</td>
														<td><input class="text__block" type="text"
															name="o_Qty[]" id="o_Qty[]" placeholder="예) 1" required>
														</td>
													</tr>
												</tbody>
											</table>
